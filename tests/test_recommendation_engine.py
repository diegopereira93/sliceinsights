...
class MockPaddle:
    def __init__(self, id=None, power_rating=None, twist_weight=None, control_rating=None, spin_rating=None, name="Paddle"):
...
def test_ranking_logic_slider():
    ...
    assert ranked[0]["paddle"].model_name == "ControlPaddle"
