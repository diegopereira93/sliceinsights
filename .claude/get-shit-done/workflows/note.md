...
- **Global scope**: `/home/diego/Documentos/projetos/data-products/sliceinsights/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/diego/Documentos/projetos/data-products/sliceinsights/.claude/notes/`)
...
2. Glob `/home/diego/Documentos/projetos/data-products/sliceinsights/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/diego/Documentos/projetos/data-products/sliceinsights/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/diego/Documentos/projetos/data-products/sliceinsights/.claude/notes/` — works in any directory
