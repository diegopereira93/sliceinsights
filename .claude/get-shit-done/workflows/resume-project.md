...
<required_reading>
@/home/diego/Documentos/projetos/data-products/sliceinsights/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/diego/Documentos/projetos/data-products/sliceinsights/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
