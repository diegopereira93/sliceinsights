...
- Usage: Reference from command with `@/home/diego/Documentos/projetos/data-products/sliceinsights/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/diego/Documentos/projetos/data-products/sliceinsights/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/diego/Documentos/projetos/data-products/sliceinsights/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
