...
| HIGH | 43 paddles (50%) have no US dump match — manual research needed | Unresolved |
...
| Complete specs (all 9 fields) | 0 (0%) | 100% | CRITICAL |
| US dump match rate | 32 (37%) | >80% | WARNING |
| Non-paddles detected | 0 | 0 | OK |
| Duplicate groups | 0 | 0 | OK |
| Paddles with active offers | 86 (100%) | 100% | OK |
| Smoke test result | PASS | PASS | OK |
| Low-price paddles (< R$ 450) | 3 | — | WARNING |
...
|---|-------|--------|-----|--------|
| 1 | core_thickness_mm | 0/86 | 0% | CRITICAL |
| 2 | face_material | 0/86 | 0% | CRITICAL |
| 3 | core_material | 0/86 | 0% | CRITICAL |
| 4 | shape | 0/86 | 0% | CRITICAL |
| 5 | swing_weight | 0/86 | 0% | CRITICAL |
| 6 | spin_rpm | 0/86 | 0% | CRITICAL |
| 7 | power_rating | 0/86 | 0% | CRITICAL |
| 8 | handle_length | 0/86 | 0% | CRITICAL |
| 9 | image_url | 86/86 | 100% | OK |
...
|-------|-------------|--------|
| CHECK 1 | Specs Confidence Gate | OK - All 0 active paddles pass (none have confidence=1.0) |
| CHECK 2 | No Fabricated Ratings | OK - No fabricated ratings detected |
| CHECK 3 | Market Offers Present | OK - All 0 active paddles have offers |
| CHECK 4 | Required Fields Complete | OK - All 0 active paddles have 8/8 fields |
