...
- **Global scope**: `/home/diego/Documentos/projetos/data-products/sliceinsights/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/diego/Documentos/projetos/data-products/sliceinsights/.gemini/notes/`)
...
2. Glob `/home/diego/Documentos/projetos/data-products/sliceinsights/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/home/diego/Documentos/projetos/data-products/sliceinsights/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/diego/Documentos/projetos/data-products/sliceinsights/.gemini/notes/` — works in any directory
