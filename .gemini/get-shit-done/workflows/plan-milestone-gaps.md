...
PHASES=$(node "/home/diego/Documentos/projetos/data-products/sliceinsights/.gemini/get-shit-done/bin/gsd-tools.cjs" phases list)
...
```bash
node "/home/diego/Documentos/projetos/data-products/sliceinsights/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md .planning/REQUIREMENTS.md
```
